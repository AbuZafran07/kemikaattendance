      ...
      <div className="container mx-auto px-4 py-6 max-w-lg space-y-6">
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            setShowCamera(true);
          }} disabled={isProcessing} className="w-full h-10 font-semibold text-lg bg-primary hover:bg-primary/90">
                <Camera className="h-5 w-5 mr-2" />
                {isProcessing ? "Memproses..." : "Check Out"}
              </Button> : <Button onClick={() => {
            setCameraMode("checkin");
            setShowCamera(true);
          }} disabled={isProcessing} className="w-full h-10 font-semibold bg-primary hover:bg-primary/90 text-base">
                <Camera className="h-5 w-5 mr-2" />
